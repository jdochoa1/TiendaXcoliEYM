...
<script type="text/javascript">	
	...
	xmlhttp.open("GET","bolsa.php?bolsa="+bolsa,true);
	xmlhttp.send();
}
...
<table width = '70%' align='center'>
	...
	<a href="anulafactura.php"  class="enlaceboton" target = "blank_">Anular Factura</a>
...
<table border = '1' width = '70%' align='center'>
	<tr>
		...
		<td><input type = "text" id="bolsa" name="bolsa" OnChange = "showBolsa(this.value);" placeholder = "Numero de Bolsas"></td>
