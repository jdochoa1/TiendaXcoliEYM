 ...
 **************************************************************************/
	...
	$tcpdf['base_url'] = base_url() . '/application/3rdparty/tcpdf/';
 ...
 **************************************************************************/
	...
	$tcpdf['creator'] = 'NeoInvoice';
	$tcpdf['author'] = 'NeoInvoice';
	...
	$tcpdf['header_font'] = 'rockwell';
	$tcpdf['header_font_size'] = 10;
	$tcpdf['header_margin'] = 5;
	$tcpdf['header_title'] = 'NeoInvoice';
	$tcpdf['header_string'] = "by Renowned Media";
	 ...
	 * ----------------------------------------------------------
	 * Enable the footer, set the font, default text, and margin
	 ***********************************************************/
