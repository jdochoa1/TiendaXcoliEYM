...
if(!empty($_SESSION['vector'])){
	...
	$insert = mysql_query("insert into $VENTAS values ('','".$cons."','".$_SESSION['doc']."','".$_SESSION['nom']."',now(),'".$_SESSION['dire']."','".$_SESSION['tel']."','".$_SESSION['mail']."','".$_SESSION['tpago']."','".$_SESSION['vector'][$i]."','".$_SESSION['vector_nom'][$i]."','".$_SESSION['vector_cant'][$i]."','".$_SESSION['vector_pre'][$i]."','".$_SESSION['vector_tot'][$i]."','','".$_SESSION['vector_bod'][$i]."','','')");
