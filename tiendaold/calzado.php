...
<table width = '70%' align='center'>
	...
	<tr height = '90'>
		...
		<td colspan = '4'>
			<input type "text" id="doc" name="doc" size = "60" value = "<?php echo @$_SESSION['doc'];?>"><br>
			<input type "text" id="nom" name="nom" size = "60" value = "<?php echo @$_SESSION['nom'];?>"><br>
			<input type "text" id="dire" name="dire" size = "60" value = "<?php echo @$_SESSION['dire'];?>"><br>
			<input type "text" id="tel" name="tel" size = "60" value = "<?php echo @$_SESSION['tel'];?>"><br>
			<input type "text" id="mail" name="mail" size = "60" value = "<?php echo @$_SESSION['mail'];?>"><br>
